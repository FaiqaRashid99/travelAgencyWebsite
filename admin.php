...
<body>
	...
	<div class="container">
		...
		<div class="customer-workspace work" id="id1">
			...
			<div id="tb-container" style="display: none; margin-top: 50px; font-size:20px">
		...
		<div class="agent-workspace work" id="id2">
			...
			<div id="agent-container" style="display: none; margin-top: 50px;">
				<table align="center" border="1Spx" style="width: 700px; line-height: 30px; font-size:20px">
					<tr>
		...
		<div class="places-workspace work" id="id3">
			...
			<div id="place-container" style="display: none; margin-top: 50px;">
				<table align="center" border="1px" style="width: 500px; line-height: 30px; font-size:20px">
					<tr>
